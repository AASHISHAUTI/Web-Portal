...
<body>
 ...
 <form  id = "BD_daily" method="POST" action="add.php">
                ...
                <div class="row form-group">
                    <div class="col-sm-2">
                        <label class="control-label modal-label">Follow Up from Counseller:</label>
                    </div>
                    <div class="col-sm-10">
                ...
                <div class="row form-group">
                    <div class="col-sm-2">
                        <label class="control-label modal-label">Total Call For Meeting:</label>
                    </div>
                    <div class="col-sm-10">
                ...
                <div class="row form-group">
                    <div class="col-sm-2">
                        <label class="control-label modal-label">Any Visit:</label>
                    </div>
                    <div class="col-sm-10">
                ...
                <div class="row form-group">
                    <div class="col-sm-2">
                        <label class="control-label modal-label">Direct Walking:</label>
                    </div>
                    <div class="col-sm-10">
                ...
                <div class="row form-group">
                    <div class="col-sm-2">
                        <label class="control-label modal-label">Direct Call:</label>
                    </div>
                    <div class="col-sm-10">
